...
HD_PWD='C:/Users/pakanalk/OneDrive - Rose-Hulman Institute of Technology/Class Files/RISCy Expansion/DRIVE/FPGA_Implementation/DRIVE/DRIVE.runs/design_1_clk_wiz_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_clk_wiz_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_clk_wiz_1.tcl
