...
HD_PWD='C:/Users/pakanalk/OneDrive - Rose-Hulman Institute of Technology/Class Files/RISCy Expansion/DRIVE/FPGA_Implementation/DPR_ALU/DPR_ALU.runs/prc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prc_0.tcl
