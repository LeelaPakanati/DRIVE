...
#
# Generated by export_simulation on Sun Jan 13 15:42:12 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './prc_0.sh' script.
...
./prc_0.sh -noclean_files

For more information on the script, please type './prc_0.sh -help'.
